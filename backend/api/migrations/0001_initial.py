# Generated by Django 5.2.6 on 2025-12-11 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['name', 'address'], name='restaurant_name_address_idx'), models.Index(fields=['average_rating'], name='Restaurants_average_421f53_idx'), models.Index(fields=['quality_score'], name='Restaurants_quality_98204f_idx'), models.Index(fields=['detail_url'], name='restaurant_detail_url_idx')],
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['status'], name='CrawledData_status_ecd65d_idx'), models.Index(fields=['source', 'status'], name='CrawledData_source__87ccda_idx'), models.Index(fields=['source', 'url'], name='crawled_source_url_idx')],
            },
        ),
        migrations.CreateModel(
